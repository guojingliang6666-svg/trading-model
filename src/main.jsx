...
function analyzeStock(s) {
  ...
  if (s.bollExpanding) { bull += 1; sigs.push("布林线开口扩张中"); }
...
function App() {
  ...
  const [mktExtra, setMktExtra] = useState(null);
    ...
    <div style={{ background: C.bg, minHeight: "100vh", color: C.text, fontFamily: "'Noto Sans SC', 'PingFang SC', sans-serif", maxWidth: 480, margin: "0 auto", paddingBottom: 80 }}>
      ...
      <div style={{ padding: "14px 14px 0" }}>
        ...
        {tab === "stage" && (
          <div>
            <Card>
              <SecTitle icon="地图">选择当前阶段</SecTitle>
            ...
            {stageInfo && (
              <>
                ...
                <Card>
                  ...
                  {selStage === 6 && <div style={{ color: C.red, fontSize: 13, lineHeight: 1.9 }}>• <b style={{ color: C.red }}>清仓空仓</b>，不言底<br />• EXPMA空头排列，下跌有量<br />• 中轨从支撑变压力<br />• 下轨是下一个目标位，不接反弹</div>}
